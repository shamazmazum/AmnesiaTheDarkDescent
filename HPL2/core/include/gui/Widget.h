...
namespace hpl {
    ...
    public:
        ...
        bool ProcessMessage(eGuiMessage aMessage, const cGuiMessageData &aData, bool abSkipVisCheck = false,
        ...
        virtual cGuiGlobalShortcut *
        AddShortcut(int alKeyModifiers, eKey aKey, eGuiMessage aMsg = eGuiMessage_ButtonPressed,
    ...
    protected:
        ...
        void DrawDefaultTextHighlight(const tWString &asText,
                                      ...
                                      eFontAlign aAlign); //, int alFirstVisibleChar, int alHighlightStart, int alHighlightSize);
