...
namespace hpl {
    ...
    public:
        cGuiRenderObject() : mpGfx(NULL), mvPos(0), mvSize(0), mColor(0, 0), mpCustomMaterial(NULL), mpClipRegion(NULL),
                             mbRotated(false), mfAngle(0.0f), mvPivot(0.0f) {}
    ...
    public:
        cGuiGlobalShortcut(int alKeyModifiers, eKey aKey, iWidget *apWidget, eGuiMessage aMessage,
                           bool abBypassVisiblity, bool abBypassEnabled);
    ...
    public:
        ...
        cGuiGlobalShortcut *AddGlobalShortcut(int alKeyModifiers, eKey aKey, iWidget *apWidget, eGuiMessage aMessage,
        ...
        cGuiPopUpFilePicker *CreatePopUpSaveFilePicker(tWString &asFileName, const tWString &asCategory,
                                                       const tWString &asFilter, const tWString &asStartPath,
                                                       bool abShowHidden,
                                                       void *apCallbackObject, tGuiCallbackFunc apCallback,
        ...
        cGuiPopUpColorPicker *
        CreatePopUpColorPicker(cColor *apDestColor, const cVector3f &avPos, void *apCallbackObject,
