...
namespace hpl {
    ...
    public:
        ...
        */
        ...
        static void
        ExpandAABB(cVector3f &avBaseMin, cVector3f &avBaseMax, const cVector3f &avAddMin, const cVector3f &avAddMax);
        ...
        static inline bool
        CheckPointInSphereIntersection(const cVector3f &avPoint, const cVector3f &avSpherePos, float afSphereRadius) {
            cVector3f vSepAxis = avPoint - avSpherePos;
            return vSepAxis.SqrLength() <= afSphereRadius * afSphereRadius;
        }

        static inline bool
        CheckSphereIntersection(const cVector3f &avPosA, float afRadiusA, const cVector3f &avPosB, float afRadiusB) {
        ...
        */
        static bool
        CheckSphereLineIntersection(const cVector3f &avSpherePos, float afSphereRadius, const cVector3f &avLineStart,
                                    const cVector3f &avLineEnd, float *apT1, cVector3f *apIntersection1, float *apT2,
        ...
        */
        ...
        static bool
        CheckPointInAABBIntersection(const cVector3f &avPoint, const cVector3f &avMin, const cVector3f &avMax);
        ...
        */
         ...
         */
        static cRect2l
        GetClipRectFromNormalizedMinMax(const cVector3f &avMin, const cVector3f &avMax, const cVector2l &avScreenSize);
        ...
        */
        ...
        static bool CheckPointInFlatPolygon(const cVector3f &avRayStart, const cVector3f &avRayEnd,
                                            ...
                                            unsigned int *apIntersectedTriIndex, cVector3f *apIntersectionWorldSpace,
         ...
         */
        static bool
        CheckPointSameSideOfEdge2D(const cVector3f &avPoint1, const cVector3f &avPoint2, const cVector3f &avPoint3,
                                   const cVector3f &avPoint4);
        ...
        */
        ...
        static void
        Vector3OrthonormalizeBasis(const cVector3f &avSrcRight, const cVector3f &avSrcUp, const cVector3f &avSrcForward,
        ...
        */
        static cVector3f
        GetPoint3DFromSphericalCoords(const cVector3f &avSphCenter, float afSphRadius, const cVector2f &avSphCoords);
         ...
         */
        static bool
        PlaneIntersectionPoint(const cPlanef &aP1, const cPlanef &aP2, const cPlanef &aP3, cVector3f &avPoint);
        ...
        */
        static eCollision CheckPlaneAABBCollision(const cPlanef &aPlane, const cVector3f &avMin, const cVector3f &avMax,
                                                  const cVector3f &avSphereCenter,
                                                  float afSphereRadius);

        static eCollision
        CheckPlaneAABBCollision(const cPlanef &aPlane, const cVector3f &avMin, const cVector3f &avMax);
         ...
         */
        static bool
        CheckPlaneLineIntersection(const cPlanef &aPlane, const cVector3f &avLineStart, const cVector3f &avLineEnd,
                                   cVector3f *apIntersectionPos, float *apT);
         ...
         */
        static eCollision
        CheckPointsPlanesCollision(cVector3f *apVertices, int alNumOfVertices, cPlanef *apPlanes, int alNumOfPlanes);

        /**
        *  Checks if the points are all inside (inside), some inside (intersect) or all outside (outside) of the planes of an AABB.
        */
        static eCollision
        CheckPointsAABBPlanesCollision(cVector3f *apVertices, int alNumOfVertices, const cVector3f &avMin,
                                       const cVector3f &avMax);

        /**
        *  Does a sepperating axis collision check! Planes do only need to contain normal!
        */
        static bool CheckSeparatingAxisIntersection(cVector3f *apVerticesA, int alNumOfVerticesA, cPlanef *apPlanesA,
                                                    int alNumOfPlanesA,
                                                    cVector3f *apVerticesB, int alNumOfVerticesB, cPlanef *apPlanesB,
                                                    int alNumOfPlanesB);
        ...
        */
        static bool CheckLineTriMeshIntersection(const cVector3f &avLineStart, const cVector3f &avLineEnd,
                                                 ...
                                                 cVector3f *apIntersectionPos, float *apT, int *apTriIndex,
        ...
        */
         ...
         * \return
         */
        static cMatrixf MatrixUnitVectors(const cVector3f &avRight, const cVector3f &avUp, const cVector3f &avForward,
         ...
         */
        static cMatrixf
        ProjectionMatrixObliqueNearClipPlane(const cMatrixf &a_mtxProjMatrix, const cPlanef &aClipPlane);

        /**
         * Creates a perspective projection matrix.
         */
        static cMatrixf
        MatrixPerspectiveProjection(float afNearClipPlane, float afFarClipPlane, float afFOV, float afAspect,
                                    bool abInfFarPlane);
         ...
         */
        static cMatrixf
        MatrixOrthographicProjection(float afNearClipPlane, float afFarClipPlane, const cVector2f &avViewSize);
