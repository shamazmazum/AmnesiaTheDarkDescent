...
#include "player/cLuxPlayerState_Normal.h"
#include "player/cLuxPlayerState_HandObject.h"
#include "player/cLuxPlayerState_UseItem.h"
#include "player/cLuxPlayerState_InteractGrab.h"
#include "player/cLuxPlayerState_InteractPush.h"
#include "player/cLuxPlayerState_InteractSlide.h"
#include "player/cLuxPlayerState_InteractSwingDoor.h"
#include "player/cLuxPlayerState_InteractLever.h"
#include "player/cLuxPlayerState_InteractWheel.h"
#include "player/cLuxPlayerState_Ladder.h"
...
cLuxPlayer::cLuxPlayer() : iLuxUpdateable("cLuxPlayer"), iLuxCollideCallbackContainer()
{
	//////////////////////////////////
	// Init data pointers
	mpCharBody = NULL;
