...
void cLuxAreaRopeLoader::Load(const tString &asName, int alID, bool abActive, const cVector3f &avSize,
...
cLuxRope::cLuxRope(const tString &asName, int alID, cLuxMap *apMap) : iLuxEntity(asName, alID, apMap,
                                                                                 eLuxEntityType_Rope) {
    mbRopeCreated = false;
